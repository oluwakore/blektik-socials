...
function Discover() {
  ...
  const activeTopicStyle = "xl:border-2 hover:bg-primary xl:border-cyan-800 px-3 py-2 rounded xl:rounded-full flex items-center gap-2 justify-center cursor-pointer text-cyan-800"
  ...
  return (
    <div className="xl:border-b-2 xl:border-gray-200 pb-6">
      {/* <p className="text-gray-500 font-semibold m-3 mt-4 xl:block"> Popular Topics</p> */}
